...
def classify_new_image(image_path, model, scaler):
    ...
    # Predict class using trained Decision Tree model
...
if __name__ == "__main__":
    print("Starting image classification using Decision Trees...")

    start_time = time.time()  # Start time

    # Check if model and scaler exist
    model_file = r'Comparative Analysis\decision_tree_model.pkl'
    scaler_file = r'Comparative Analysis\decision_tree_scaler.pkl'
