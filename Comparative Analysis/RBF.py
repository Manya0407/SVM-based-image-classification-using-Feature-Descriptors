...
if __name__ == "__main__":
    ...
    model_file = r'Comparative Analysis\svm_rbf_model.pkl'
    scaler_file = r'Comparative Analysis\rbf_scaler.pkl'
    ...
    new_image_path = r'.\Unseen Image\nature_img.jpeg'  # Replace with the path to your new image
