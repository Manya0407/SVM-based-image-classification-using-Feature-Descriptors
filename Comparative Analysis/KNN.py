...
def classify_new_image(image_path, model, scaler):
    ...
    # Predict class using trained KNN model
...
if __name__ == "__main__":
    print("Starting image classification using KNN...")

    start_time = time.time()  # Start time

    # Check if model and scaler exist
    model_file = r'Comparative Analysis\knn_model.pkl'
    scaler_file = r'Comparative Analysis\knn_scaler.pkl'
